...
export const ALL_COUNTRIES: CountryInfo[] = [
  ...
  { code: "CI", name: "Côte d'Ivoire (Ivory Coast)", currency: "XOF" },
  ...
  { code: "SZ", name: "Eswatini (Swaziland)", currency: "SZL" },
...
export const COUNTRY_TO_CURRENCY_MAP: Record<string, Currency> = ALL_COUNTRIES.reduce(
  (acc, item) => {
